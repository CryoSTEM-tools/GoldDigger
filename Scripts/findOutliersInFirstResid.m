...
% This is the first outlier removal
...
filename = 'TS_001/residual_model.resid';
startRow = 2;
...
opts.ExtraColumnsRule = "ignore";
opts.EmptyLineRule = "read";
multi = readtable("TS_001/multi1.txt", opts);
...
writematrix(single(finalFiducialFile),'TS_001/TS_001_outliersRemoved.txt','Delimiter',' ');
